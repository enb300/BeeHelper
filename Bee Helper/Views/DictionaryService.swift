    ...
    private func loadDictionary() {
        ...
        if let dictPath = Bundle.main.path(forResource: "cleaned_scraped_words", ofType: "txt") {
            do {
                ...
                isLoaded = true
                print("Loaded \(dictionary.count) words from comprehensive dictionary")
                return
            } catch {
                print("Error loading comprehensive dictionary: \(error)")
            }
        }
        
        // Fallback to basic dictionary if comprehensive dictionary not found
        let basicWords = [
            "THE", "AND", "FOR", "ARE", "BUT", "NOT", "YOU", "ALL", "CAN", "HER", "WAS", "ONE", "OUR", "OUT", "DAY", "GET", "HAS", "HIM", "HIS", "HOW", "MAN", "NEW", "NOW", "OLD", "SEE", "TWO", "WAY",
            ...
            "COULD", "EACH", "EVEN", "EVERY", "FIND", "FIRST", "FOUND", "FROM", "GIVE", "GOES", "GOOD", "GREAT", "HAD", "HAS", "HAVE", "HERE", "HIGH", "INTO", "JUST", "KNOW", "LARGE", "LITTLE", "LONG", "LOOK",
            "MADE", "MAKE", "MANY", "MIGHT", "MORE", "MOST", "MOVE", "MUCH", "MUST", "NAME", "NEAR", "NEVER", "NEXT", "ONLY", "OVER", "PART", "PEOPLE", "PLACE", "RIGHT", "SAID", "SAME", "SEEM", "SHOULD", "SMALL",
            "SOUND", "STILL", "SUCH", "TAKE", "TELL", "THAN", "THAT", "THEIR", "THEM", "THEN", "THERE", "THEY", "THING", "THINK", "THIS", "THOSE", "THROUGH", "TIME", "UNDER", "VERY", "WANT", "WELL", "WENT", "WERE", "WHAT", "WHEN", "WHERE", "WHICH", "WHILE", "WHO", "WILL", "WITH", "WORD", "WORK", "WORLD", "WOULD", "YEAR", "YOUR",
...
// Data model for puzzle information
struct PuzzleData {
    let date: Date
    let letters: [String]
    ...
    var totalPangrams: Int { words.filter { Set($0).count == 7 }.count }
    var totalCompoundWords: Int { words.filter { $0.contains("ING") || $0.contains("NESS") || $0.contains("LESS") }.count }
} 